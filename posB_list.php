...
<body>
  <div class="headerDiv">
    <div style="height: 100%; width: 13%; float: left;">
        ...
        <div style="height: 100%; width: 87%; float: left">
          <br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <FONT face=Perpetua Titling MT size=10 COLOR=white>Sales Summary of POS B</FONT>
        </div>
  </div>
  <div class="spaceDiv">
  ...
  <tr>
    <?php
      include "db.php";
      //$conn = OpenCon();
      $sql = "SELECT * FROM pos2 ORDER BY pos2_id ASC";

      if(isset($_GET['search'])){
        $employee_no = trim($_GET['pos2_id']);
      ...
      if($result->num_rows > 0){
        ...
        while($row = $result->fetch_assoc()){
          ...
          <tr>
            ...
            <td><?php echo $row['total_disc'];?></td>
            <td><?php echo $row['total_discd'];?></td>
            <td><?php echo $row['cash_given'];?></td>
            <td><?php echo $row['cus_change'];?></td>
          </tr>
          <?php
        }
        echo "</table>";
      ...
      $sql = "SELECT * FROM pos2 WHERE pos2_id = $searchTB";

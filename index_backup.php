      ...
      <div class=sideL>
        <div style="height: 100%; width: 49%; float: left;">
          ...
          <menu>
           ...
           <br>
            Discounted <br>Amount: <input type="text" id="disCItem" name="disCItem" style="width: 100px; height: 30px" value="<?php if (isset($withDisc)) echo $withDisc ?><?php if (isset($withDisc2)) echo $withDisc2 ?>"><br>
           <br>
            Total Bills: <input type="text" id="tBills" name="tBills" style="width: 90px; height: 30px" value="<?php if (isset($withDisc)) echo $withDisc ?><?php if (isset($currTotal)) echo $currTotal ?>"><br>
           <br>
